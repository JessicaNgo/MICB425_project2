...
Since we are interested in the gene narG, we will look at NO2 and NO3. First, we remake our abundance plot and save it as an object, "plot1"
```{r}
plot1 = narG.all %>% 
# Change NAs to "unclassified" at the level you want to plot
  mutate(Phylum = ifelse(is.na(Phylum), "unclassified", Phylum)) %>% 
...
plot_grid(plot3, plot2, plot1, labels=c("A", "B", "C"), axis="l", nrow=1, ncol=3, rel_widths=c(1/4, 1/4, 1))
```